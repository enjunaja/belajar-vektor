...
def beranda_menu():
    ...
    st.write("")
    st.image("https://raw.githubusercontent.com/enjunaja/belajar-vektor/main/gambar/Webinar-pana.png?token=GHSAT0AAAAAACMH4J3I2I7FHOS3YRFN4DAGZMTRNDA",width=1000)
